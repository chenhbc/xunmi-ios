...
- (void)viewConfig
{
    ...
    _navgationTabBar.backgroundColor = [UIColor colorWithRed:2/255.0 green:133/255.0 blue:240/255.0 alpha:1];
...
- (void)showLineWithButtonWidth:(CGFloat)width
{
    ...
    _line.backgroundColor = UIColorWithRGBA(255.0f, 255.0f, 255.0f, 0.9f);
